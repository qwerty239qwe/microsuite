...
| Kraken2, Bracken, MetaPhlAn, ALDEx2, MaAsLin2, LEfSe | partial | Kraken2 CI smoke-tested; others planned | Kraken2 wrapper and container are runnable; remaining profilers are API placeholders. |
