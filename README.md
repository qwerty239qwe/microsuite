...
| Kraken2, Bracken, MetaPhlAn, ALDEx2, MaAsLin2, LEfSe | partial | Kraken2 CI smoke-tested; MetaPhlAn heavy image manual-gated; others planned | Kraken2 and MetaPhlAn wrappers are runnable; remaining profilers are API placeholders. |
