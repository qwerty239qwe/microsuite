    ...
    *,
    ...
    steps = [
        ...
        Step(
            ...
            [table, rep_seqs, stats],
        ),
        Step(
            "denoising_stats_tabulate",
            [
                qiime,
                "metadata",
                "tabulate",
        ...
        Step(
            ...
            [
                ...
                threads_value,
                "--o-alignment",
                str(artifacts / "aligned-rep-seqs.qza"),
                "--o-masked-alignment",
                str(artifacts / "masked-aligned-rep-seqs.qza"),
                "--o-tree",
                str(artifacts / "unrooted-tree.qza"),
                "--o-rooted-tree",
                str(rooted_tree),
            ],
            [
        ...
        Step(
            "diversity_core_metrics_phylogenetic",
            [
                qiime,
                "diversity",
        ...
        Step(
            ...
            [
                ...
                "--i-alpha-diversity",
                str(metrics / "faith_pd_vector.qza"),
                "--m-metadata-file",
                str(metadata),
                "--o-visualization",
        ...
        Step(
            ...
            [
                ...
                "--i-distance-matrix",
                str(metrics / "unweighted_unifrac_distance_matrix.qza"),
                "--m-metadata-file",
                str(metadata),
                "--m-metadata-column",
                "body-site",
        ...
        Step(
            ...
            [
                ...
                "plot",
                "--i-pcoa",
                str(metrics / "unweighted_unifrac_pcoa_results.qza"),
                "--m-metadata-file",
                str(metadata),
                "--o-visualization",
                str(viz / "unweighted-unifrac-emperor.qzv"),
            ],
        ...
        Step(
            ...
            [
                ...
                str(rooted_tree),
                "--p-max-depth",
                str(DEFAULT_MAX_RAREFACTION_DEPTH),
                "--m-metadata-file",
                str(metadata),
                "--o-visualization",
                str(viz / "alpha-rarefaction.qzv"),
            ],
            [viz / "alpha-rarefaction.qzv"],
        ),
        Step(
            "extract_classifier_reads",
            [
                qiime,
                "feature-classifier",
                "extract-reads",
        ...
        Step(
            ...
            [
                ...
                str(metadata),
                "--o-visualization",
                str(viz / "taxa-barplot.qzv"),
            ],
            [viz / "taxa-barplot.qzv"],
        ),
        Step(
            "filter_gut_samples",
            [
        ...
        Step(
            ...
            [
                ...
                str(differentials),
                "--o-visualization",
                str(viz / "ancombc-subject.qzv"),
            ],
            [viz / "ancombc-subject.qzv"],
        ),
        Step(
            "taxa_collapse_level_6",
            [
                qiime,
                "taxa",
                "collapse",
        ...
        Step(
            ...
            [
                ...
                "subject",
                "--o-differentials",
                str(differentials_l6),
            ],
            [differentials_l6],
        ),
        Step(
            "da_barplot_subject_level_6",
            [
                qiime,
                "composition",
                "da-barplot",
                ...
                str(differentials_l6),
                "--o-visualization",
                str(viz / "ancombc-subject-l6.qzv"),
            ],
        ...
        steps.insert(
            ...
            Step(
                ...
                [
                    ...
                    threads_value,
                    "--o-table",
                    str(artifacts / "deblur-table.qza"),
                    "--o-representative-sequences",
                    str(artifacts / "deblur-rep-seqs.qza"),
                    "--o-stats",
                    str(artifacts / "deblur-stats.qza"),
                ],
                [
                    artifacts / "deblur-table.qza",
                    artifacts / "deblur-rep-seqs.qza",
